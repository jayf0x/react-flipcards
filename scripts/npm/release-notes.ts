...
const prompt = `Summarize an npm release of "react-flip-cards" (a tiny, ref-driven 3D flip-card component for React, used to build flip clocks, countdowns, counters, tickers and scoreboards).
